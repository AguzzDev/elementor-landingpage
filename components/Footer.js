                    ...
                    <div className="w-4/12 xl:w-3/12">
                        ...
                        <div>
                            ...
                            <div className="flex w-4/6 mb-5">
                                ...
                                <button className="flex justify-center items-center py-3 px-5 bg-pinklight text-pinkstronge">Subscribe</button>
                            </div>
